// ======================================================================
// FinalDesignProject.v generated from TopDesign.cysch
// 12/01/2025 at 00:22
...
module top ;
	...
	cy_clock_v1_0
		#(.id("6baac5e0-6a01-4f84-aa68-2e51bae362a5"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e2637df6-9fc2-4ef8-ab7a-d8dad31252a7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("c510415e-8537-49fa-92b8-00081f9f8eb8"),
		  .source_clock_id(""),
		  .divisor(0),
